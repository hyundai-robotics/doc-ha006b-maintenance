...
그림 2.2 로봇 명판 부착 위치 [HA006B/HA006L]# 2.3. 기본사양
...
그림 3.11 로봇 설치면 정도# 3.5.5. 비상 정지 시간 및 거리 
...
그림 3.14 3차원 부하 모델 3D 형상

<br>

③  허용 관성모멘트 제한

표 3-5 블록별 무게중심에서의 관성 모멘트
<style type="text/css">
.tg  {border-collapse:collapse;border-spacing:0;}
.tg td{border-color:black;border-style:solid;border-width:1px;font-family:Arial, sans-serif;font-size:14px;
  overflow:hidden;padding:10px 5px;word-break:normal;}
...
그림 4.2 주요 볼트 점검 부위 [HA006L]# 4.4. 본체 내 배선 점검
...
그림 4.3 케이블 점검 부위 [HA006B/HA006L]# 4.5. 타이밍 벨트 점검
...
그림 4.4 B축 타이밍 벨트 장력 체크 부위# 5. 보수
...
(로봇 오버홀(Overhaul)시 수준계를 이용한 정밀 원점 맞춤을 실시할 수 있습니다. 정밀 원점맞춤이 필요할 경우 당사로 문의하여 주십시오.)# 6.4.2. HA006B/HA006L모터 교환 방법
...
그림 6.12 B/R1축 모터교체 (HA006B/HA006L)# 6.4.3. S축 감속기 교환방법 [HA006B]
...
그림 6.20 S축 감속기 분해도 [HA006L]# 6.4.6. H, V축 감속기 교환 방법 [HA006L]
...
그림 6.25 원점 설정 방법 [HA006B]

![](../../_assets/그림_6.26_원점설정방법_ha006l.png)

그림 6.26 원점 설정 방법 [HA006L]# 6.5.2. 엔코더 리셋
...
그림 9.1 본체 부품 배치 [HA006B]

![](../_assets/그림_10.2_본체_부품_배치.png)

그림 9.2 본체 부품 배치 [HA006L]
